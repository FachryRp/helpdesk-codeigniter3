...
class Select extends CI_Controller
{
	...
	function select_departemen()
	{
		...
		if (trim($id_divisi) == "") {
			$data['dd_departemen'] = $this->model_app->get_departemen('ea');
			$data['id_departemen'] = "";
		} else {
			$data['dd_departemen'] = $this->model_app->get_departemen($id_divisi);
			$data['id_departemen'] = "";
		}

		$this->load->view('combo/select_departemen', $data);
	}
}
