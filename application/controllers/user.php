...
class User extends CI_Controller
{
	...
	function user_list()
	{
		...
		// $datauser1 = $this->model_app->datauser1();
		// $data['datauser1'] = $datauser1;

		$datauser2 = $this->model_app->datauser2();
		$data['datauser2'] = $datauser2;
	...
	function add()
	{
		...
		//$data['dd_dept'] = $this->model_app->dropdown_departemen();
		//$data['id_dept'] = "";
