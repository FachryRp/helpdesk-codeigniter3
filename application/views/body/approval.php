								...
								<tbody>
									...
									foreach ($dataapproval as $row) : $no++; ?>
										<tr>
											...
											<!-- <td data-field="idd"><?php echo $row->id_ticket; ?></a></td> -->
											<td data-field="idd"><a href="<?php echo base_url(); ?>myticket/myticket_detail/<?php echo $row->id_ticket; ?>"><?php echo $row->id_ticket; ?></a></td>
											<td data-field="iddd"><?php echo $row->tanggal; ?></td>
											<td data-field="idD"><?php echo $row->nama; ?><?php echo $row->nama_karyawan; ?></td>
