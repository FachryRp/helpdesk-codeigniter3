				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><svg class="glyph stroked hourglass">
							...
							<a href="#" style="text-decoration:none">Approval Pending dan Selesai</a>
						</div>
							...
							<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
									<tr>
										...
										<!-- <th data-field="idddddC" data-sortable="true">Keterangan Pending</th> -->
										<th data-field="idddddF" data-sortable="true">Keterangan</th>
										<th data-field="idddddd" data-sortable="true">Aksi</th>
									</tr>
								</thead>
								<tbody>
									<?php $no = 0;
									foreach ($dataapproval_requestor as $row) : $no++; ?>
										<tr>
											...
											<!-- <td data-field="iddd"><?php echo $row->tanggal; ?></td> -->
											<td data-field="iddd">
												<?php if ($row->status == 8) { ?>
											...
											<!-- <td data-field="id"><?php echo $row->keterangan_pending; ?></td> -->
											<td data-field="idddddF">
												<?php if ($row->status == 8) { ?>
											...
											<!-- <td data-field="idddddF"><?php echo $row->deskripsi ?></td> -->
											<td data-field="idddddd">


												<?php if ($row->status == 8) { ?>
													<a class="ubah btn btn-success btn-xs" href="<?php echo base_url(); ?>myassignment/pending/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-ok"></span></a>
													...
													<a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>myassignment/terima_req/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-remove"></span></a>
													<!-- <a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>>myassignment/terima/<?php echo $row->id_ticket; ?>?status=3">
														<span class="glyphicon glyphicon-remove"></span> -->
													</a>
												<?php } else if ($row->status == 6) { ?>
													<a class="ubah btn btn-success btn-xs" href="<?php echo base_url(); ?>approval/terima_selesai/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-ok"></span></a>
													...
													<a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>approval/proses/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-remove"></span></a>
													<!-- <a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>myassignment/terima/<?php echo $row->id_ticket; ?>?status=3">
														<span class="glyphicon glyphicon-remove"></span>
													</a> -->

												<?php } else if ($row->status == 7) { ?>
													<a class="ubah btn btn-success btn-xs" href="<?php echo base_url(); ?>approval/close_ticket/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-ok"></span></a>
													<!-- <a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>myassignment/pending/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-minus-sign"></span></a> -->
													<a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>approval/proses/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-remove"></span></a>
													<!-- <a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>myassignment/terima/<?php echo $row->id_ticket; ?>?status=3">
														<span class="glyphicon glyphicon-remove"></span>
