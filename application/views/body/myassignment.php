										...
										<tr>
											...
											<td data-field="id">
												...
												<?php if ($row->status == 4) { ?>
													...
													<a class="ubah btn btn-danger btn-xs" href="<?php echo base_url(); ?>myassignment/formpending/<?php echo $row->id_ticket; ?>"><span class="glyphicon glyphicon-minus-sign"></span></a>
