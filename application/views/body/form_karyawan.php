<script language="javascript" type="text/javascript">
	$(document).ready(function() {
		...
		$("#id_departemen").change(function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url() . 'model_app/get_departemen' ?>",
				data: data,
		...
		$(document).ready(function() {
			$("#id_divisi").change(function() {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>select/select_departemen", // Perhatikan bahwa tidak ada kode PHP di dalam URL
					data: data,
					success: function(msg) {
						$('#div-order').html(msg);
					}
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading"><svg class="glyph stroked male user ">
				...
				<a href="#" style="text-decoration:none">Tambah Data Karyawan</a>
			</div>
					...
					<form method="post" action="<?php echo base_url(); ?><?php echo $url; ?>">
						...
						<div id="div-order">
							...
							<?php if ($flag == "edit") {
								...
								echo form_dropdown('id_departemen', $dd_departemen, $id_departemen, 'required class="form-control"');
							} else {
							}
							?>
