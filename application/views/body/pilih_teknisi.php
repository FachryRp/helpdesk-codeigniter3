				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><svg class="glyph stroked male user ">
							...
							<a href="<?php echo base_url(); ?>departemen/add" style="text-decoration:none">Pembagian Tugas</a>
						</div>
						<div class="panel-body">
							...
							<div class="list-group">
								...
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-user"></span> &nbsp;<?php echo $reported; ?><?php echo $reported2; ?></a>
								<a href="#" class="list-group-item">Subject Masalah : </br></br> &nbsp;<?php echo $problem_summary; ?></a>
								<a href="#" class="list-group-item">Masalah Detail :</br></br> &nbsp;<?php echo $problem_detail; ?></a>
							</div>
