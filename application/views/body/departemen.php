				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><svg class="glyph stroked male user ">
							...
							<a href="<?php echo base_url(); ?>departemen/add" style="text-decoration:none">Tambah Data Departemen</a>
						</div>
							...
							<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
									<tr>
										...
										<th data-field="div" data-sortable="true">Divisi</th>
										<th>Aksi</th>
									</tr>
								</thead>
								<tbody>
									<?php $no = 0;
									foreach ($datadepartemen as $row) : $no++; ?>
										<tr>
											<td data-field="no" width="10px"><?php echo $no; ?></td>
											<td data-field="id"><?php echo $row->nama_dept; ?></td>
											<td data-field="nama_div"><?php echo $row->nama_divisi; ?></td>
											<td>
