  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading"><svg class="glyph stroked male user ">
        ...
        <a href="<?php echo base_url(); ?>list_ticket/ticket_list" style="text-decoration:none">Profile</a>
      </div>
      ...
      <div class="panel-body">
        ...
        <div class="list-group">
          ...
          <a href="#" class="list-group-item"><span class="glyphicon glyphicon-certificate"></span> &nbsp;<?php echo $dept; ?></a>
          <!-- <a href="#" class="list-group-item"><span class="glyphicon glyphicon-th-large"></span> &nbsp;<?php echo $bagian; ?></a> -->
          <a href="#" class="list-group-item"><span class="glyphicon glyphicon-th-large"></span> &nbsp;<?php echo $divisi; ?></a>
          <a href="#" class="list-group-item"><span class="glyphicon glyphicon-briefcase"></span> &nbsp;<?php echo $jabatan; ?></a>
          <a href="#" class="list-group-item"><span class="glyphicon glyphicon-wrench"></span> &nbsp;<?php echo $level; ?></a>
        </div>
