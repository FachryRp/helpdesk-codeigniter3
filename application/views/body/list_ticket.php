				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><svg class="glyph stroked male user ">
							...
							<!-- <a href="<?php echo base_url(); ?>departemen/add" style="text-decoration:none">List Ticket <a href="<?php echo base_url(); ?>list_ticket/pdflistticket2" class="btn btn-danger" target="_blank">Pdf</a></a> -->
							<a href="#" style="text-decoration:none">List Ticket <a href="<?php echo base_url(); ?>list_ticket/pdflistticket2" class="btn btn-danger" target="_blank">Pdf</a></a>
						</div>
								...
								<tbody>
									...
									foreach ($datalist_ticket as $row) : $no++; ?>
										<tr>
											...
											<td data-field="iddsd"><?php echo $row->nama; ?><?php echo $row->nama_karyawan; ?></td>
											<td data-field="iddsd"><?php echo $row->nama_dept;
																	echo $row->nama_unit ?></td>
