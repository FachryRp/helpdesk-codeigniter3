		...
		<ul class="nav menu">
			...
			<?php if ($this->session->userdata('level') == "ADMIN") { ?>
				...
				<li><a href="<?php echo base_url(); ?>list_ticket/ticket_list"><svg class="glyph stroked notepad ">
						...
						</svg> List Ticket (<?php if (empty($notif_list_ticket)) {
												echo "0";
											} else {
				...
				<li><a href="<?php echo base_url(); ?>approval/approval_list"><svg class="glyph stroked email">
						...
						<use xlink:href="#stroked-male-user"></use></svg> Approval Ticket (<?php if (empty($notif_approval)) {
																								echo "0";
																							} else {
																								echo $notif_approval;
																							} ?>)
					</a></li>
				<li><a href="<?php echo base_url(); ?>approval/approval_requestorlist"><svg class="glyph stroked hourglass">
							<use xlink:href="#stroked-hourglass" />
						</svg> Approval (<?php if (empty($notif_pending)) {
												echo "0";
											} else {
												echo $notif_pending;
											} ?>)</a></li>
				<!-- <li><a href="<?php echo base_url(); ?>approval/approval_requestorlist_adm"><svg class="glyph stroked hourglass">
							<use xlink:href="#stroked-hourglass" />
						</svg> Approval Pending(<?php if (empty($notif_pending_adm)) {
													echo "0";
												} else {
													echo $notif_pending_adm;
												} ?>)</a></li> -->
				<!-- <li><a href="<?php echo base_url(); ?>approval/approval_requestorlist"><svg class="glyph stroked hourglass">
							<use xlink:href="#stroked-hourglass" />
						</svg> Approval (<?php if (empty($notif_pending)) {
				...
				<li><a href="<?php echo base_url(); ?>divisi/divisi_list"><svg class="glyph stroked app-window">
			...
			<?php
				...
				<li><a href="<?php echo base_url(); ?>myassignment/myassignment_list"><svg class="glyph stroked clipboard with paper">
						...
						</svg> My Assigment Ticket
						(<?php if (empty($notif_assignment)) {
								echo "0";
							} else {
								echo $notif_assignment;
							} ?>)</a></li>
			...
			<?php
			} else if ($this->session->userdata('hak_akses') == "Teknisi") { ?>
			...
			<?php } else if ($this->session->userdata('hak_akses') == "Pegawai") { ?>
				<li class="active"><a href="<?php echo base_url(); ?>home"><svg class="glyph stroked dashboard-dial">
							<use xlink:href="#stroked-dashboard-dial"></use>
						</svg> Dashboard</a></li>
				<li class="active"><a href="<?php echo base_url(); ?>ticket/add"><svg class="glyph stroked open folder">
